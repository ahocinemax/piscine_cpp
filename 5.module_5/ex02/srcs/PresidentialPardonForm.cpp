...
{
	std::cout << name << " called PPF full constructor" << std::endl;
}
...
PresidentialPardonForm::PresidentialPardonForm(const PresidentialPardonForm &Copy) : Form(Copy)
{
	if (this != &Copy)
		*this = Copy;
	std::cout << Copy.name << " called PPF copy constructor" << std::endl;
}

PresidentialPardonForm::PresidentialPardonForm(void) : Form("PresidentialPardonForm", 25, 5), name("NO_NAME")
{
	std::cout << name << " called PPF default constructor" << std::endl;
}

PresidentialPardonForm::~PresidentialPardonForm(void)
{
	std::cout << name << " called PPF destructor" << std::endl;
}
...
PresidentialPardonForm &PresidentialPardonForm::operator=(const PresidentialPardonForm &rhs)
{
	...
	std::cout << name << " called PPF copy assignement operator" << std::endl;
	return (*this);
}
...
void	PresidentialPardonForm::action(const Bureaucrat &manager) const
{
	...
	std::cout << manager.getName() << " have been pardoned by Zafod Beeblebrox" << std::endl;
}
